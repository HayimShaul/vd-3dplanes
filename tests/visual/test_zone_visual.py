"""Phase 4 snapshot figures for the HTML gallery.
...
from vd3d.viz.scenes_zone import PHASE4_SCENES
...
@pytest.mark.visual
@pytest.mark.parametrize("scene", PHASE4_SCENES, ids=lambda scene: scene.name)
def test_phase4_scene_snapshot(scene: Scene):
