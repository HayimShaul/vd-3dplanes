...
from vd3d.viz.scenes_robustness import PHASE10_SCENES
...
@pytest.mark.visual
@pytest.mark.parametrize("scene", PHASE10_SCENES, ids=lambda scene: scene.name)
def test_phase10_scene_snapshot(scene: Scene):
