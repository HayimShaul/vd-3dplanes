"""Phase 3 snapshot figures for the HTML gallery.
...
from vd3d.viz.scenes_vd import PHASE3_SCENES
...
@pytest.mark.visual
@pytest.mark.parametrize("scene", PHASE3_SCENES, ids=lambda scene: scene.name)
def test_phase3_scene_snapshot(scene: Scene):
