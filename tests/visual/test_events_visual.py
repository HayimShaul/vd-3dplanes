"""Phase 5 snapshot figures. Human review is the rotatable GUI, not the HTML page.
...
from vd3d.viz.scenes_events import PHASE5_SCENES
...
@pytest.mark.visual
@pytest.mark.parametrize("scene", PHASE5_SCENES, ids=lambda scene: scene.name)
def test_phase5_scene_snapshot(scene: Scene):
