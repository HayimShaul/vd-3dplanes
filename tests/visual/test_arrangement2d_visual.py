"""Phase 2 snapshot figures for the HTML gallery.
...
from vd3d.viz.scenes_arrangement import PHASE2_SCENES
...
@pytest.mark.visual
@pytest.mark.parametrize("scene", PHASE2_SCENES, ids=lambda scene: scene.name)
def test_phase2_scene_snapshot(scene: Scene):
