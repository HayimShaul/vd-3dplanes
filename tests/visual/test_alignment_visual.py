...
from vd3d.viz.scenes_alignment import PHASE6_SCENES
...
@pytest.mark.visual
@pytest.mark.parametrize("scene", PHASE6_SCENES, ids=lambda scene: scene.name)
def test_phase6_scene_snapshot(scene: Scene):
