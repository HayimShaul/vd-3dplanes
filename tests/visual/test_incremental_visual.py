...
from vd3d.viz.scenes_incremental import PHASE9_SCENES
...
@pytest.mark.visual
@pytest.mark.parametrize("scene", PHASE9_SCENES, ids=lambda scene: scene.name)
def test_phase9_scene_snapshot(scene: Scene):
